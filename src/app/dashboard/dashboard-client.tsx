...
export default function Dashboard({ initialUserData, token }: { initialUserData: UserData, token: string }) {
  ...
  useEffect(() => {
    ...
    const refreshUserData = async () => {
      try {
        const updatedUserData = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/user/`, {
